...
### 6. Acceptable use
You agree **not** to:
- Reverse engineer, decompile, or scrape the App except where local law overrides this prohibition.
- Use automated tools to harvest user or content data.
- Impersonate another person, create misleading accounts, or harass other users.
- Send spam or bulk invitations.
- Attempt to bypass rate limits, authentication, or tier restrictions.
...
- You may terminate your account at any time via **Settings → Delete account**. Paid subscriptions are governed by the app store's refund policy post-termination.
...
We may update these Terms. Material changes will be announced in-app and via email where we have one. The "Effective date" at the top reflects the current version. Continued use after a change constitutes acceptance.

### 12. Governing law + disputes
These Terms are governed by Turkish law without regard to its conflict-of-law rules. Disputes will be resolved in the courts of İstanbul, Türkiye, unless mandatory consumer-protection law in your jurisdiction grants you a different forum.

### 13. Contact
Questions, complaints, data requests: **mkceliks@gmail.com**.
...
### 13. İletişim
Soru, şikâyet, veri talebi: **mkceliks@gmail.com**.
